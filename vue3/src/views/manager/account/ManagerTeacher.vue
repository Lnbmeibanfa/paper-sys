...
import { selectTeacherDataAPI, deleteByIdAPI, deleteBatchAPI, addTeacherAPI } from '@/api/teacher'
...
const save = () => {
  addTeacherAPI(data.formData).then((res) => {
    if (res.code === '200') {
...
<template>
  ...
  <!--dialog-->
  <el-dialog v-model="data.dialogVisible" title="增加老师" width="700">
